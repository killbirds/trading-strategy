...
- **총 필터 종류**: 16개 (RSI, MACD, BollingerBand, ADX, MovingAverage, Ichimoku, VWAP, Copys, ATR, SuperTrend, Volume, ThreeRSI, CandlePattern, SupportResistance, Momentum, Slope)
- **총 필터 타입 수**: 약 310개 이상
