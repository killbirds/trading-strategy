...
pub fn filter_vwap<C: Candle + 'static>(
    ...
    let result = match params.filter_type {
        ...
        2 => analyzer.is_price_near_vwap(params.consecutive_n, &vwap_params, params.threshold),
        // 3: VWAP 상향 돌파 (매수 신호)
        ...
        8 => analyzer.is_price_above_vwap(&vwap_params, params.consecutive_n),
        // 9: 고가와 저가 모두 VWAP 아래에 있음 (강한 하락) - 간소화
        9 => analyzer.is_price_below_vwap(&vwap_params, params.consecutive_n),
